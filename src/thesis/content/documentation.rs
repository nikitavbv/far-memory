...
у доступі до даних, тим більш ефективною буде віддалена памʼять."),
        ...
        paragraph("- моделі машинного навчання (згорткові нейронні мережи, трансформери та ін.) - застосування таке ж, як до задачі передбачування послідовності."),
