...
розробки ефективного методу надання віддаленої памʼяті в розподілених інформаціних системах."),
        ...
        Block::UnorderedList(vec![
            ...
            "визначено метод інтеграції у програмне забезпечення за допомогою клієнтської бібліотеки що надає розумні показчики для зберігання \
обʼєктів у віддаленій памʼяті та стуктури даних адаптовані для роботи з нею".to_owned(),
...
та разміщення частин даних на різних вузлах".to_owned(),
...
досягти на 53% більшу пропускну здатність у порівнні з більш простими алгоритмами заміщення проміжків".to_owned(),
