use {
    ...
    crate::thesis::{
        engine::{Block, paragraph, unordered_list, count_pages, count_images, count_tables, count_applications, PageCountingError, count_references, section_header},
...
fn thesis_content_inner(abstract_content: AbstractContent) -> Block {
    ...
    */
    Block::Multiple(vec![
        ...
        // table of contents
        Block::Placeholder(Box::new(section_header("Зміст".to_uppercase())), "remove numbering".to_owned()),
        Block::TableOfContents,

        // abbreviations
        Block::Placeholder(Box::new(section_header("Перелік умовних позначень".to_uppercase())), "remove numbering".to_owned()),
        Block::Placeholder(
        ...
        // intro
        Block::Placeholder(Box::new(section_header("Вступ".to_uppercase())), "remove numbering".to_owned()),
        ...
        Block::Placeholder(
            Box::new(Block::Multiple(vec![
                Block::Placeholder(Box::new(section_header("Висновок".to_owned())), "remove numbering".to_owned()),
        ...
        // references
        Block::Placeholder(Box::new(section_header("Перелік посилань".to_uppercase())), "remove numbering".to_owned()),
