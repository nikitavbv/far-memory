...
вирішує задачу інтеграції у програмне забезпечення."),
...
надає можливість інтегруватись у нове та існуюче програмне забезпечення без змін у код."),
        paragraph("Для забезпечення відмовостійкості, у цій роботі пропонується підхід під назнвою CodingSets. Під час перенесення даних у памʼять 
інших вузлів, виконується кодування кодом Ріда-Соломона, що дає декілька частин даних (data splits) та парності (parity splits). Підхід CodingSets 
...
доки відбувається відновлення даних на новий вузел."),
