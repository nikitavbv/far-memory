use {
    crate::thesis::{
        ...
        engine::{Block, ImageBlock, subsection_header, paragraph, unordered_list, section_header, SubsectionHeaderBlock}
    },
    self::{
        aifm::aifm,
        carbink::carbink,
...
програм або віртуальних машин, кожна з яких використовує його частину часу, а разом всі - використовують процесор майже весь час, при цьому розрахунок йде на те, що піки завантаженості цих програм не збігаються."#.to_owned()),
...
забезпечення для розгортання та використання віддаленої памʼяті. Для досягення мети необхідно вирішити наступні задачі:"),
...
програмному забезпеченні."),
        ...
        paragraph("У першому розділі розглянуто проблему надання віддаленої памʼяті у роздподілених системах та виконано аналіз існуючих реалізацій. Визначено які підходи \
використовуються для інтеграції віддаленої памʼяті у нове та існуюче програмне забезпечення."),
        /*paragraph("У першому розділі виконано аналіз існуючих програмних засобів надання віддаленої памʼяті та предметної області, проаналізовані основні сучасні підходи до \
побудови таких систем, визначено переваги та недоліки цих рішень. В результаті проведеного аналізу сформульована постановка задачі, наведене призначення, цілі та задачі \
розробки."),*/
    ])
}
