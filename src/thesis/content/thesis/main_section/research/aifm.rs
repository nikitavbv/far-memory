...
pub fn aifm() -> Block {
    Block::Multiple(vec![
        ...
        paragraph(vec![
            ...
            " на відміну від попередніх реалізацій віддаленої памʼяті не потребує спеціалізованого апартного забезпечення, для передачі даних використовується TCP.".into(),
        ]),
