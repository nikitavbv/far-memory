...
pub fn aifm() -> Block {
    Block::Multiple(vec![
        ...
        paragraph("Система Application-Integrated Far Memory (AIFM) на відміну від попередніх реалізацій віддаленої памʼяті не потребує спеціалізованого апартного забезпечення, для передачі даних використовується TCP."),
