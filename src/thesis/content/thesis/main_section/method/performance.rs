...
до проміжків памʼяті."),
        ...
        paragraph("Іншим алгоритмом, що розглядається в цій роботі, є алгоритм заміщення сторінок на основі рекурентної нейронної мережі (recurrent neural network). \
