...
клієнт віддаленої памʼяті переключиться на використання алгоритму заміщення проміжків що базується на цій моделі."),
        paragraph("Прогнозна модель що використовується такими алгоритмами заміщення проміжків приймає на вхід історію доступів до проміжків памʼяті. На виході така модель \
