...
проміжків на ефективність роботи віддаленої памʼяті. Розглянуто можливі реалізації алгоритмів заміщення проміжків, описано механізм збору статистики доступу до проміжків \
