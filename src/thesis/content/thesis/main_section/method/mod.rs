...
кількість операцій доступу до проміжків памʼяті та їх переміщення, що має негативний ефект на швидкодію. Для вирішення цієї проблеми, у цій роботі використовується ..."),
        // tell a bit about size classes.
