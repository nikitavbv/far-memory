...
pub fn far_memory_method() -> Block {
    Block::Multiple(vec![
        ...
        // tell about manager node, storage nodes and integration (using library or service running on the end node). Tell what span is here.

        subsection_header("Інтеграція у програмне забезпечення"),
        // tell how library and service running on the end node would be working more specifically. Tell how spans are swapped in and out here.
        ...
        // tell about reasoning behind partial swap in/swap out. tell why compression is not used.
