...
використання цього алгоритму є виправданим. Так само цей алгоритм може бути виправданим у програмному забезпеченні яке має закономірності доступу до памʼяті які роблять \
цей алгоритм ефективним: програмне забезпечення, у якому до деякої частини даних приходить набагато більше запитів ніж до інших даних. Легко помітити неефективність цього \
алгоритму для програмного забезпечення яке регулярно виконує доступ до проміжків памʼяті у певному порядку. Прикладами програмного забезпечення з цього класу може бути \
програмне забезпечення яке виконує обчислення де значний обсяг даних використовується у певному порядку, наприклад, нейронні мережі чи бази даних які виконують сканування \
таблиці у певному порядку. Для такого програмного забезпечення алгоритм заміщення найменш нещодавно використаних проміжків ..."), // TODO: tell that it will lead to the worse performance.
