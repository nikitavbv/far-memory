...
За основу була взята існуюча реалізація з відкритим кодом цієї програми на мові програмування Rust (llama2-rs). Ця програма в циклі обробляє запити на \
генерацію наступного токена тексту. Показником швидкодії для цього програмного забезпечення є кількість згенерованих токенів у хвилину."), // todo: tell about weights stored in far memory and which class of software is represented.
        // ...
