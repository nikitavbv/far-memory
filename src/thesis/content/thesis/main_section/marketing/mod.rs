...
що вони вже використовують для цієї задачі."),
        ...
        paragraph("Наступним кроком є розробка стратегії позиціонування на основі вимог до продукту та обраної базової стратегії розвитку. Визначення стратегії \
позиціонування наведено у таблиці 5.17."),
        // TODO: add table.
