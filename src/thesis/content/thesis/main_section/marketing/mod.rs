...
забезпечення є ефективним для підвищення зацікавленності серед потенційних користувачів."),
        ...
        paragraph("Першим кроком розроблення ринкової стратегії проекту є визначення стратегії охоплення ринку. Опис цільових груп потенційних користувачів \
наведено у таблиці 5.14."),
        Block::Table(TableBlock::new(
            vec![
                TableCell::new("№".into()),
