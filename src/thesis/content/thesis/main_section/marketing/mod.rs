        ...
        Block::Table(TableBlock::new(
            ...
            vec![
                vec![
                    ...
                    TableCell::new("Зменшення використання локальної памʼяті за рахунок перенесення даних у памʼять віддалених вузлів".into()),
...
у зовнішніх центрах обробки даних і не пропонується як продукт чи послуга."),
        Block::Table(TableBlock::new(
            vec![
            ...
            vec![
                ...
                vec![
                    ...
                    TableCell::new("Відкритий вихідний код та доступність для зовнішнього використання".into()).font_size(12).width(comparison_table_property_width),
...
У таблиці 5.3 проведено аналіз технологічної здійсненності ідеї проекту."),
        Block::Table(TableBlock::new(
            vec![
            ...
            vec![
                ...
                vec![
                    ...
                    TableCell::new("Відстеження доступу до даних за допомогою розумних покажчиків та лічильника посилань".into()).width(technology_table_description_width),
                ...
                vec![
                    ...
                    TableCell::new("Прогнозування доступу до проміжків даних за допомогою рекурентної нейаронної мережі".into()).width(technology_table_description_width),
        ...
        paragraph("Виходячи з проведеного аналізу, технологічна здійсненність проекту можлива, найбільш прийнятні технології, що було обрані, є наявними та \
доступними."),
...
дорівнювати розміру ринку віртуалізації ($86 мільярдів), оскільки потреба в використанні віддаленої памʼяті виникає у схожих середовищах.".into()),
                ],
                vec![
...
покращення рівня швидкодії що збільшить область застосування.".into()).width(risks_table_solution_width),
                ...
                vec![
                    ...
                    TableCell::new("Відповідність продукту очікуванням та потребам сегменту".into()).width(risks_table_factor_width),
                    TableCell::new("Рівень швидкодії віддаленої памʼяті не дозволяє інформаційним системам, в які віддалена памʼять інтегрується, дотримуватись \
        ...
        Block::Table(TableBlock::new(
            ...
            vec![
                vec![
                    ...
                    TableCell::new("Рекламна компанія спрямована на ознайомлення клієнтів з можливістю використання віддаленої памʼяті.".into()).width(opportunities_table_text_width),
                ],
                vec![
...
конкуренції на ринку розглянуто у таблиці 5.8.".into(),
        ...
        Block::Table(TableBlock::new(
            vec![
                ...
                TableCell::new("В чому проявляється дана характеристика".into()).width(competition_table_description_width),
                TableCell::new("Вплив на діяльність підприємства (можливі дії компанії, щоб бути конкурентоспроможною)".into()).width(competition_table_description_width),
            ],
            vec![
                vec![
...
над іншими програмними продуктами.".into()).width(competition_table_description_width),
                ],
                vec![
...
проблему більш ефективного використання оперативної памʼяті".into()).width(competition_table_description_width),
                    TableCell::new("Адаптація програмного забезпечення під зміни у інфраструктурі та компоненти інформаційних систем. Підвищення ефективності \
надання віддаленої памʼяті за рахунок використання покращень інших продуктів та технологій (наприклад, нові можливості апаратної платформи які можна використати \
...
не більш ефективна реалізація підходу, а використання більш ефективних підходів.".into()).width(competition_table_description_width),
...
інформаційній системі у порівнянні з затратами на інтеграцію віддаленої памʼяті у програмне забезпечення.".into()).width(competition_table_description_width),
                    TableCell::new("Постійний моніторинг ефективності віддаленої памʼяті для різних типів програмного забезпечення, пошук шляхів зменшення \
...
для надання віддаленої памʼяті. Це означає, що програмний продукт що розробляється у цьому проекті повинен мати властивості що роблять його використання \
...
порівнянні з інтеграцією віддаленої памʼяті на рівні програмного забезпечення, що зумовлено меншою кількістю доступної інформації про доступ до даних \
у віддаленій памʼяті.".into()),
                ],
            ],
            "Аналіз конкуренції в галузі за М. Портером".to_owned(),
        ).with_split(vec![4])),
        paragraph("З проведеного аналізу можна зробити висновок що з огляду на конкурентну ситуацію існує можливість роботи на ринку. Для того, щоб \
проект був конкурентоспроможним на ринку він повинен мати більшу ефективність у порівнянні з іншими методами збільшення ефективності використання \
оперативної памʼяті."),

        paragraph(vec![
            "Фактори конкурентоспроможності докладніше розглянуто в таблиці 5.10.".into(),
            TextSpan::PageBreak,
        ]),
        Block::Table(TableBlock::new(
            vec![
                TableCell::new("№".into()),
                TableCell::new("Фактор конкурентоспроможності".into()),
...
більшій ефективності.".into()),
                ...
                vec![
                    ...
                    TableCell::new("Розробка простих методів розгортання віддаленої памʼяті та її інтеграції у програмне забезпечення робить програмний продукт \
більш конкурентоспроможнім за програмні продукти конкурентів що мають більш складне розгортання та налаштування чи вимоги до програмної та апаратної платформи.".into()),
                ],
                vec![
                    TableCell::new("4".into()),
...
памʼяті що має більш низьку ефективність, що обмежує область застосування.".into()),
            ...
            "Обґрунтування факторів конкурентоспроможності".to_owned(),
        ).with_split(vec![4])),

        paragraph("Базуючись на визначених факторах конкурентоспроможності було проведено аналіз слабких сторін стартап-проекту. Порівняльний аналіз \
наведено у таблиці 5.11."),
        Block::Table(TableBlock::new(
            vec![
                TableCell::new("№".into()).merge_continue(),
                TableCell::new("Фактор конкурентоспроможності".into()).merge_continue(),
...
використання віддаленої памʼяті є допустимим);".into(),
                        TextSpan::Break,
                        "- потенційна наявність альтернатив у вигляді відповідного функціоналу у програмному забезпеченні віртуалізації та хмарної \
інфраструктури.".into(),
                    ].into()),
                ],
                vec![
...
систем що можуть створити привід для інтеграції віддаленої памʼяті у ці системи.".into(),
                    ...
                    TableCell::new(vec![
                        "- незацікавленість клієнтів використанням віддаленої памʼяті на користь інших методів підвищення ефективності використання \
...
цього є найбільш ймовірним, строки відносно стислі, а результат у вигляді звітів по зниження використання ресурсів для демонстраційного програмного \
забезпечення є ефективним для підвищення зацікавленості серед потенційних користувачів."),
        ...
        Block::Table(TableBlock::new(
            ...
            vec![
                vec![
                    ...
                    TableCell::new("Низька, оскільки підвищення ефективності використання ресурсів не буде мати значного результату через невелику кількість \
...
інформаційної системи, конкуренцією з власними розробками підприємства.".into()),
                ...
                vec![
                    ...
                    TableCell::new("Середня, оскільки такі підприємства не завжди мають можливість змінювати програмний код програмного забезпечення що \
працює у їх центрах обробки даних (така можливість є лише для високорівневого програмного забезпечення що вони самі розробляють та надають як послугу). \
...
сформовано у таблиці 5.15.".into(),
        ...
        Block::Table(TableBlock::new(
            vec![
                ...
                TableCell::new("Ключові конкурентоспроможні позиції відповідно до обраної альтернативи".into()),
...
повідомлення про результати та рекламувати в соціальних мережах, на конференціях і т.д.".into()),
                    TableCell::new("Легкість інтеграції та наявність підтверджень високої ефективності програмного продукту та можливості застосування \
...
таблиці 5.16.".into(),
        ...
        Block::Table(TableBlock::new(
            vec![
                ...
                TableCell::new("Чи буде компанія шукати нових споживачів, або забирати існуючих у конкурентів?".into()),
...
щоб користувачі програмного продукту конкурентів розглядали можливість міграції".into()),
            ...
            "Визначення базової стратегії конкурентної поведінки".to_owned(),
        )),
...
позиціонування наведено у таблиці 5.17.".into(),
        ...
        Block::Table(TableBlock::new(
            vec![
                ...
                TableCell::new("Базова стратегія розвитку".into()),
                TableCell::new("Ключові конкурентоспроможні позиції".into()),
            ...
            vec![
                ...
                vec![
                    ...
                    TableCell::new("Працювати з даними у віддаленій памʼяті настільки ж легко, як з даними у локальній памʼяті".into()),
                ],
                vec![
                    TableCell::new("3".into()),
...
витрата)".into()).font_size(12),
                    ...
                    TableCell::new("Важко визначити через наявність великої кількості різних підприємств у цільовій групі користувачів. \
Але, можна орієнтуватися на рівень витрат на підтримку центрів обробки даних такими підприємствами: $500тис-$50млн на рік".into()).font_size(12),
...
комунікацій наведено у таблиці 5.22."),
        Block::Table(TableBlock::new(
            vec![
                TableCell::new("Специфіка поведінки цільових клієнтів".into()).font_size(12),
                TableCell::new("Канали комунікацій, якими користуються цільові клієнти".into()).font_size(12),
                TableCell::new("Ключові позиції, обрані для позиціонування".into()).font_size(12),
                TableCell::new("Завдання рекламного повідомлення".into()).font_size(12),
                TableCell::new("Концепція рекламного звернення".into()).font_size(12),
            ],
            vec![
                vec![
                    TableCell::new("Цільові клієнти зацікавлені в збільшенні ефективності використання ресурсів центру обробки даних \
шляхом внесення змін в інформаційну систему вартість яких є нижчою за вартість ресурсів що було використано більш ефективно".into()).font_size(12),
                    TableCell::new("Веб-сайти в інтернеті, соціальні мережі, тематичні конференції".into()).font_size(12),
                    TableCell::new("Легкість у інтеграції та використанні, значний позитивний вплив на ефективність використання \
оперативної памʼяті серверів у центрі обробки даних".into()).font_size(12),
                    TableCell::new("Звернути увагу на використання віддаленої памʼяті як інструменту зниження витрат на обслуговування \
та розширення центру обробки даних.".into()).font_size(12),
                    TableCell::new("Прозоре збільшення обсягу оперативної памʼяті у сервері клієнта".into()).font_size(12),
                ],
            ],
            "Концепція маркетингових комунікацій".to_owned(),
        )),

        paragraph("Отже, було створено маркетингову програму що включає в себе концепції програмного продукту, збуту, просування та \
попередній аналіз можливостей ціноутворення."),

        Block::SubsectionHeader(SubsectionHeaderBlock::without_numbering("Висновки до розділу".to_owned())),
        paragraph("В цьому розділі було проведено маркетинговий аналіз стратап-проекту. Для цього було описано ідею проекту, проведено \
її технологічний аудит, аналіз ринкових можливостей. Було проаналізовано конкуренцію на ринку, можливості та загрози. Була розроблена \
ринкова стратегія проекту, обрана стратегія розвитку та стратегія конкурентної поведінки. Для стартап-проекту було розроблено \
маркетингову програму."),
        paragraph("З огляду на наявність попиту, його зростання та рентабельність роботи на ринку, можна зробити висновок що можливість \
ринкової комерціалізації проекту існує. Конкурентоспроможність проекту є високою що робить його перспективним для впровадження, існує \
заінтересована група клієнтів для якої барʼєр входження не є високим."),
        paragraph("Варіантом впровадження для ринкової реалізації проекту доцільно обрати інтеграцію віддаленої памʼяті у демонстраційне \
програмне забезпечення (популярне програмне забезпечення з відкритим кодом що широко використовується, таке як бази даних), дослідження \
ефективності та створення звітів, які потом можна використати у маркетинговій програмі."),
        paragraph("Проведений аналіз підтверджує що подальша імплементація проекту є доцільною."),
    ])
}
